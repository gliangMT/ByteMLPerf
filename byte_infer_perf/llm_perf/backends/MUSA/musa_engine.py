...
from llm_perf.backends.MUSA.musa_process_messager import MUSAMultiProcessMsgr
from llm_perf.utils.logger import logger


class MUSAEngine(CoreEngine):
    ...
    def __init__(
        ...
        **kwarg
        ...
        if self.world_size > 1:
            self.mlp_manager = MUSAMultiProcessMsgr(
    ...
    def setup(self):
        ...
        self.model = MUSAEngine.load_model(self.model_config, "MUSA")
    ...
    def prepare_inputs(self, batch: List[CoreEngine.Packet]) -> Dict:
        model_inputs = MUSAEngine.Packet.prepare_inputs(
            batch, 
